...
const cities: Record<string, CityData> = {
  oslo: {
    ...
    metaTitle: "Boligpriser i Oslo 2026 – Se hva boliger koster i din bydel | Verdikart",
  ...
  tromso: {
    ...
    uniqueNote: "Tromsø er øykommune — Tromsøya har begrenset areal og kan ikke ekspandere sidelengs som fastlandsbyer. Det betyr at nybygg nesten alltid er høyhus eller fortetting, og at tomteknapphet holder prisene stabile selv i nedgangstider. Kilen-broen og Sandnessundbroen kobler øya til fastlandet, men rushtrafikk kan gi 20–30 minutters forsinkelse i begge retninger.",
  ...
  bodoe: {
    ...
    uniqueNote: "Bodø er i ferd med å gjennomføre Norges største byutviklingsprosjekt nord for Trondheim: den gamle flyplassen (Bodø Lufthavn) flyttes 2 km, og det frigjorte arealet midt i byen — 2 400 mål — skal bli en helt ny bydel med 8 000–10 000 innbyggere. Første byggetrinn starter 2026. Dette er en sjelden mulighet: å kjøpe i en by der sentrumsarealet dobles og infrastrukturen moderniseres.",
