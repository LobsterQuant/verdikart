...
/**
 * Rounded accent pill summarizing the nearest Entur StopPlace — mode,
 * distance in metres, stop name. Rendered only when transit data is
 * available; caller filters.
 */
export function TransitPill({
  ...
  return (
    <span className="inline-flex items-center gap-1.5 rounded-full border border-accent/25 bg-accent/10 px-3 py-1 text-[12px] font-medium text-accent">
      ...
      <span className="tabular-nums text-text-muted">{distanceM}m</span>
