 ...
 *
 * Extracted from CrimeCard so the mobile property-report aggregator
 * (src/lib/propertyReportSummary.ts) can compose a preview without
 * pulling in the "use client" card bundle.
 *
...
export const NATIONAL_CRIME_AVG = 57.4;
